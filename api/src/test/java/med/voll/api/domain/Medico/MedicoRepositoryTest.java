...
@DataJpaTest
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE) // n substituir banco de dados
...
class MedicoRepositoryTest {
    ...
    @Test
    @DisplayName("Deveria devolver null quando não houver médico disponível na data")
    void escolherMedicoAleatorioLivreNaDataCenario1() {
        ...
        var paciente = cadastrarPaciente("Paciente","paciente@gmail.com", "12312312313") ;
